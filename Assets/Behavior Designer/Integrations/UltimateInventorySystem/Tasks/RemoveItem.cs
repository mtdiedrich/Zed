    ...
    public class RemoveItem : Action
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (itemCollection != null) {
                ...
                itemInfoToRemove = itemCollection.GetItemInfo(m_ItemDefinition.Value);
                if (itemInfoToRemove == null) { return TaskStatus.Failure; }
                
                itemInfoRemoved = itemCollection.RemoveItem((m_Amount.Value, itemInfoToRemove.Value));
              
            } else {
                itemInfoToRemove = m_Inventory.GetItemInfo(m_ItemDefinition.Value);
                if (itemInfoToRemove == null) { return TaskStatus.Failure; }
